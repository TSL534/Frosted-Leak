...
module.exports = {
    ...
    .addStringOption(option =>
        option.setName('emojie')
            .setDescription('The Emojie that should be spammed')
            .setRequired(true)
            .addChoices(
                { name: 'Random', value: '' },
                { name: 'Crosshair', value: '' },
                { name: 'Agent', value: '' },
                { name: 'Immersive Reader', value: '' },
                { name: 'Hollow Star', value: '' },
                { name: 'Solid Star', value: '' },
                { name: 'Food', value: '' },
                { name: 'Armor', value: '' },
                { name: 'Heart', value: '' },
                { name: 'Wooden Pickaxe', value: '' },
                { name: 'Wooden Sword', value: '' },
                { name: 'Crafting Table', value: '' },
                { name: 'Furnace', value: '' },
                { name: 'Minecoin', value: '' },
                { name: 'Token', value: '' },
                { name: 'Craft Toggle On', value: '' },
                { name: 'Craft Toggle Off', value: '' },
            ))
      .addStringOption(option =>
    ...
    async execute(interaction) {
        ...
        const customMessage = interaction.options.getString('emojie') || `herm`
            ...
            client.on('play_status', async (packet) => {
                try {
                    ...
                    const spamInterval = setInterval(() => {
                        ...
                        let finalMessage = `${command}`.repeat(800);
